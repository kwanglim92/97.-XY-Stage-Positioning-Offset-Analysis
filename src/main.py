...
#  Main Application
# ═══════════════════════════════════════════════
class DataAnalyzerApp(QMainWindow, ScanMixin, StepMixin, CardMixin, TableMixin, ChartMixin, XYLegendMixin, DieFilterMixin, LotFilterMixin, TiffMixin, ExportMixin):
